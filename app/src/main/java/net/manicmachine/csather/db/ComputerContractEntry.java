...
public class ComputerContractEntry extends DBContract implements BaseColumns {
    ...
    public static final String COL_COMPUTER_LAST_INV = "report_date_epoch";
    public static final String COL_COMPUTER_CHECKIN = "last_contact_time_epoch";
    public static final String COL_COMPUTER_LAST_ENROLL = "initial_entry_date_epoch";
    ...
    public static final String COL_COMPUTER_PO_DATE_epoch = "po_date_epoch";
    public static final String COL_COMPUTER_WARRANTY_EXPIRES = "warranty_expires";
    public static final String COL_COMPUTER_WARRANTY_EXPIRES_epoch = "warranty_expires_epoch";
    public static final String COL_COMPUTER_LEASE_EXPIRES = "lease_expires";
    public static final String COL_COMPUTER_LEASE_EXPIRES_epoch = "lease_expires_epoch";
