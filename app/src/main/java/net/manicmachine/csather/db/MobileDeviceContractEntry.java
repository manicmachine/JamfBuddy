...
public class MobileDeviceContractEntry extends DBContract implements BaseColumns{
    ...
    public static final String COL_MOBILE_LAST_INV = "last_inventory_update_epoch";
    ...
    public static final String COL_MOBILE_LAST_ENROLL = "last_enrollment_epoch";
    ...
    public static final String COL_MOBILE_ICLOUD_LAST_BACKUP = "last_cloud_backup_date_epoch";
    ...
    public static final String COL_MOBILE_PO_DATE_epoch = "po_date_epoch";
    public static final String COL_MOBILE_WARRANTY_EXPIRES = "warranty_expires";
    public static final String COL_MOBILE_WARRANTY_EXPIRES_epoch = "warranty_expires_epoch";
    public static final String COL_MOBILE_LEASE_EXPIRES = "lease_expires";
    public static final String COL_MOBILE_LEASE_EXPIRES_epoch = "lease_expires_epoch";
